...
## Updated by Alyssa R. Hamm, May 2025. Minimum length changed to 22bps.
...
def trim_R2(sample,ID,name,bc_to_seq):
    ...
    os.system('cutadapt -a "' + sequence + 'TCTGGCGTAGGAGG;min_overlap=4" -a "TCTGGCGTAGGAGG;min_overlap=8" --minimum-length 22 -o ' + sample + '_R2_trimmed/' + R2_file_name + '_R2_trimmed.fastq.gz ' + sample + '_selected_cells/' + R2_file_name + '.fastq.gz >> ' + sample + '_logs/trim_R2_v4/trim_R2_v4.log')
    print(R2_file_name)
